...
# Load YOLO model (use the path relative to your project)
MODEL_PATH = "../yolov8n.pt"  # Update this path if needed
...
def detect_objects(image):
    ...
    annotated_image = results[0].plot()  # This adds bounding boxes
    
    # Convert BGR to RGB (OpenCV uses BGR, Gradio expects RGB)
